 ...
 */
public class PembelianPageAnak extends JFrame implements ActionListener {
    ...
    JLabel jenisHarga = new JLabel("Rp12.700 /pcs");
    ...
    JLabel HargaSatuan = new JLabel("Rp.12.700");
