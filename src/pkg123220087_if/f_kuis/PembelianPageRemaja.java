 ...
 */
public class PembelianPageRemaja extends JFrame implements ActionListener {
    ...
    JLabel jenisHarga = new JLabel("Rp15.200 /pcs");
    ...
    JLabel HargaSatuan = new JLabel("Rp.15.200");
